const portafolio = [
  ...
  { Titulo  : 'Comercial Vas',
    ...
    links   : [
      { name: 'Demo', link: './Crud' },
      { name: 'Github', link: 'https://github.com/naxo25/php7' }
    ],
  ...
  { Titulo  : 'Trabajo de título UTFSM',
    ...
    links   : [
      ...
      { name: 'Github', link: 'https://github.com/naxo25/Python' }
  ],
    icos    : [ 'python' ]
  }
];
...
const header = [
  ...
  { to: '#Portafolio', name: 'Portafolio' },
  { to: 'https://nacholabraweb.000webhostapp.com/Tutoriales', name: 'Tutoriales' },
  { to: 'mailto:naxorojas25@gmail.com', name: 'Contacto' },
  { to: '#Redes', name: 'Redes' },
];